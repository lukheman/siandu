...
Route::get('/balita', \App\Livewire\Table\IbuHamilTable::class)->name('ibu-hamil-table')->middleware('auth');
Route::get('/ibu_hamil', \App\Livewire\Table\BalitaTable::class)->name('balita-table')->middleware('auth');
